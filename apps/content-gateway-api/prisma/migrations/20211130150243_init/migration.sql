...
-- AddForeignKey
ALTER TABLE "Data" ADD CONSTRAINT "Data_namespace_name_version_fkey" FOREIGN KEY ("namespace", "name", "version") REFERENCES "Schema"("namespace", "name", "version") ON DELETE CASCADE ON UPDATE CASCADE;
